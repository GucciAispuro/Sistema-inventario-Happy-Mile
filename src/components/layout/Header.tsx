...
const Header: React.FC<HeaderProps> = ({ title }) => {
  ...
  useEffect(() => {
    ...
    if (path.includes('/inventory')) newTitle = 'Inventory';
    else if (path.includes('/transactions')) newTitle = 'Transactions';
    else if (path.includes('/admin/items')) newTitle = 'Item Management';
    else if (path.includes('/admin/locations')) newTitle = 'Location Management';
    else if (path.includes('/admin/users')) newTitle = 'User Management';
